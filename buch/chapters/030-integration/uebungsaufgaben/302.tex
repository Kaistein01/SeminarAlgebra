...
&=
\int_0^1 
(t^6+3it^5+5it^3+3it+1)(2t+i)
\,dt
\\
&=
\int_0^1 
2t^7+7it^6-3t^5+10it^4-5t^3+6it^2-t+i
\,dt
\\
&=
\biggl[
\frac{t^8}{4}+it^7-\frac{t^6}{2}+2it^5-\frac{5t^4}{4}+2it^3-\frac{t^2}{2}+it
\biggr]_0^1
\\
&=
\frac14+i-\frac12+2i-\frac54+2i-\frac12+i
=
-2+6i.
\end{align*}
Man kann das Integral in diesem Afall aber auch sehr elegant mit partieller
Integration bestimmen
\begin{align*}
\int_{\gamma_4} f(z)\,dz
=
\int_0^1 
\underbrace{\gamma(t)^3}_{\clap{$\downarrow$}}
\cdot
\underbrace{\dot{\gamma}(t)}_{\clap{$\uparrow$}}
\,dt
&=
\biggl[
\gamma(t)^4
...
-
\int_0^1
3\gamma(t)^2\dot{\gamma}(t)\cdot\gamma(t)
\,dt
\intertext{Rechts steht bis auf den Faktor 3 das gleich Integral wie links,
so dass man sie beide auf der linken Seite zusammenfassen kann:}
4
\int_0^1
\gamma(t)^2\dot{\gamma}(t)\cdot\gamma(t)
\,dt
&=
\bigl(\gamma(1)^4 - \gamma(0)^4\bigr)
\intertext{oder aufgelöst nach dem Integral:}
\int_0^1
\gamma(t)^2\dot{\gamma}(t)\cdot\gamma(t)
\,dt
&=
\frac{\gamma(1)^4-\gamma(0)^4}{4}
=
\frac{ (2t+i)^4 - 1}{4}
=
\frac{ 24i - 8}{4}
...
-2+6i.
\end{align*}
Man beobachtet auch, dass
\[
\frac{d}{dt}\gamma(t)^4 = 4 \gamma(t)^3\cdot\dot{\gamma}(t)
\]
das Vierfache des Integranden ist, so dass
\[
\int_0^1 \gamma(t)^3\cdot\dot{\gamma}(t)\,dt
=
\frac14
\int_0^1 \frac{d}{dt}\gamma(t)^4\,dt
=
\frac14
\biggl[
\gamma(t)^4
...
\]
sein muss.
Daraus folgt wie vorhin das Resultat.
