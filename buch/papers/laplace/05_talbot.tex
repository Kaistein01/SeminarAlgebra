...
\kopfrechts{Numerische Inversion: Talbots Weg ins Tal des Integranden}%
...
\input{papers/laplace/fig/integrand_vergleich.tex}
...
\input{papers/laplace/fig/betrags_landschaft.tex}
...
Hälfte auswertet.
In der von Weideman \cite{laplace:weideman2006}
optimierten Form lautet die Kontur beispielsweise
\begin{equation}
    s(\theta)
    =
    \frac{N}{t}
...
Die sorgfältige Software-Implementierung von Murli und Rizzardi
\cite{laplace:murli1990}
bestätigt
...
\input{papers/laplace/fig/konvergenz_vergleich.tex}
