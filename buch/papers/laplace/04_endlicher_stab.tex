...
\kopfrechts{Der Stab endlicher Länge: unendlich viele Pole statt Verzweigungsschnitt}%
...
\input{papers/laplace/fig/pol_kette.tex}
...
ist das Residuum
\[
\operatorname{Res}\biggl(\frac{f_1}{f_2}, s_0\biggr)
=
\frac{f_1(s_0)}{f_2'(s_0)}.
\]
Mit $f_2(s) = \sinh(\pi\sqrt{s})$ und
$f_2'(s) = (\pi/2\!\sqrt{s})\cosh(\pi\sqrt{s})$ ergibt sich nach
