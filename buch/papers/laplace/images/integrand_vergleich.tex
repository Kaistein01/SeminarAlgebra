%
% integrand_vergleich.tex -- template for standalon tikz images
%
...
\addplot[
    thick, 
    plotred,
] table[x=omega, y=integrand, col sep=comma] {data_integrand_bromwich.csv};
\end{axis}
...
\addplot[
    thick, 
    plotblue,
] table[x=theta, y=integrand, col sep=comma] {data_integrand_talbot.csv};
...
\addplot[
    ...
    mark size=1.5pt,
    plotblue,
] table[x=theta, y=integrand, col sep=comma] {data_integrand_talbot_pts.csv};
\end{axis}
