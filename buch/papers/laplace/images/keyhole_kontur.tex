...
%
% keyhole_kontur.tex -- template for standalon tikz images
%
...
% 6. LEGENDE
% ==============================
\node[draw, thick, rounded corners=3pt, fill=white, inner xsep=5pt, inner ysep=4pt, anchor=west] at (2.3, 2.7) {
    ...
    \begin{tabular}{@{}c l@{}}
        ...
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotblue] (-0.3,0) -- (0.3,0);
            \draw[thick, plotblue, -{Stealth[length=2.5mm, width=1.8mm]}] (-0.3, 0) -- (0.15, 0);
        } & Bromwich-Pfad \\
        
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotorange] (-0.3,0) -- (0.3,0);
            \draw[thick, plotorange, -{Stealth[length=2.5mm, width=1.8mm]}] (-0.3, 0) -- (0.15, 0);
        } & Kreisbogen $\Gamma_R$ \\
        
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotgreen] (-0.3,0) -- (0.3,0);
            \draw[thick, plotgreen, -{Stealth[length=2.5mm, width=1.8mm]}] (-0.3, 0) -- (0.15, 0);
        } & Ufer $L_+, L_-$ \\
        
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotpurple] (-0.3,0) -- (0.3,0);
            \draw[thick, plotpurple, -{Stealth[length=2.5mm, width=1.8mm]}] (-0.3, 0) -- (0.15, 0);
