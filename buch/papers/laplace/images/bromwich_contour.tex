...
\draw[thick, plotblue] (2.5, -4.8) -- (2.5, 4.8);
\draw[thick,plotblue, -{Stealth[length=3.5mm, width=2.5mm]}] (2.5,-4.8) -- (2.5,0.5);
\draw[thick] (2.5, 0.15) -- (2.5, -0.15) node[below right, inner sep=2pt] {$\boldsymbol{\gamma}$};

% Text im Konvergenzbereich
\node[plotblue, align=center] at (3.75, 3) {Konvergenz-\\bereich};
...
\node[draw, thick, rounded corners=3pt, fill=white, inner xsep=5pt, inner ysep=4pt, anchor=north west] at (-5.0, 4.8) {
    ...
    \begin{tabular}{@{}c l@{}}
        ...
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotblue] (-0.3, 0) -- (0.3, 0); % Durchgehender Strich
	    \draw[plotblue, -{Stealth[length=3.5mm, width=2.5mm]}] (-0.3,0) -- (0.15,0);
        } & Bromwich-Pfad \\
