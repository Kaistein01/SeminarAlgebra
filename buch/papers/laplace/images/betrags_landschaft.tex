...
%
% betrags_lanschaft.tex -- template for standalon tikz images
%
...
\node at (11.3,4) [rotate=90] {$\log_{10}|e^{st}F(s)|$};
...
\addplot graphics [xmin=-15, xmax=5, ymin=-12, ymax=12] {heatmap_bg.png};
...
\addplot[
    ...
    postaction={decorate}
] table[col sep=comma, x=re, y=im] {talbot_contour_heatmap.csv};
