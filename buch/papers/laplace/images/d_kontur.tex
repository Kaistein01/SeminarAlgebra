...
\node[draw, thick, rounded corners=3pt, fill=white, inner xsep=5pt, inner ysep=4pt, anchor=north west] at (-5.3, 5.3) {
    ...
    \begin{tabular}{@{}c l@{}}
        ...
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotblue, decoration={markings, mark=at position 0.65 with {\arrow{Stealth[length=2mm, width=1.5mm]}}}, postaction={decorate}] (-0.3, 0) -- (0.3, 0);
        } & Bromwich-Pfad \\
        
        \tikz[baseline=-0.6ex]{
            \draw[thick, plotorange, decoration={markings, mark=at position 0.65 with {\arrow{Stealth[length=2mm, width=1.5mm]}}}, postaction={decorate}] (-0.3, 0) -- (0.3, 0);
        } & Kreisbogen $\Gamma_R$ \\
