\begin{figure}
\centering
\subfigure[{\captionfont Integration unendlich dünner Ringe zur Berechnung der Fläche eines Kreises.}\label{gamma-fig:ring-integration}]{%
...
\subfigure[{\captionfont Integration unendlich dünner Rechtecke zur Berechnung der Fläche eines Kreises.}\label{gamma-fig:rect-integration}]{%
    \begin{minipage}[c][4cm][c]{0.3\textwidth}
        \centering
        \begin{tikzpicture}
            \def\r{1}
...
\subfigure[{\captionfont Integration unendlich dünner Halbzylinder zur Berechnung des Volumens einer Kugel.}\label{gamma-fig:semicircle-integration}]{%
    \begin{minipage}[c][4cm][c]{0.3\textwidth}
        \centering
\includegraphics{papers/gamma/img/zylinder.pdf}
...
\caption{Visualisierung der geometrischen Idee hinter Flächen- und Volumenintegralen.}
\end{figure}
