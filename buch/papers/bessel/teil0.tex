...
Die Bessel-Gleichung hat im Ursprung eine Singularität, und ein gewöhnlicher Potenzreihenansatz scheitert daran.
...
Abschnitt~\ref{bessel:section:loesung} löst diese Gleichung mit dem Ansatz aus Kapitel~\ref{chapter:differentialgleichungen} und liefert die Bessel-Funktionen erster und zweiter Art.
