...
Mit~\eqref{bessel:loesung:eqn:gammafunktional} in der Form $\Gamma(z)=\Gamma(z+1)/z$ lässt sie sich im Sinne von Abschnitt~\ref{buch:analytisch:section:fortsetzung} auf ganz $\mathbb{C}$ ausser den Punkten $0,-1,-2,\dots$ analytisch fortsetzen.
Dort hat sie einfache Pole, ihr Kehrwert $1/\Gamma$ ist deshalb eine ganze Funktion und verschwindet an genau diesen Stellen.
