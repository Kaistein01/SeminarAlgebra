...
\begin{equation}
  \left\{\quad % macht auf linker Seite die grosse geschweifte Klammer (darum das \{)
  \renewcommand{\arraycolsep}{1.5pt} % überschreibt Spaltenabstand in Tabelle auf 2pt, sonst wären sie zu gross
...
Dabei entsteht eine Gleichung, die nur noch $x$ enthält. Das Auflösen nach $x$ ist trivial.
\qedhere
\end{enumerate}
\end{beispiel}
...
Diese letzte Phase des Gauss-Algorithmus nennt sich das \emph{Rückwärtseinsetzen}.

Bemerkenswert ist, dass ein zunächst schwer lösbares Gleichungssystem in ein äquivalentes Gleichungssystem umgewandelt wird, welches einfacher lösbar ist.
Zwei Gleichungssysteme werden als äquivalent bezeichnet, wenn sie exakt dieselbe Lösungsmenge besitzen.
