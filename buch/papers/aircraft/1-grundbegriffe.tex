...
\input{papers/aircraft/fig/fig-dutchroll}
...
erneut Gieren.
Beim \emph{Schieben} bewegt sich das Flugzeug in eine Richtung, die
nicht mit seiner Längsachse übereinstimmt.

Die Dutch Roll ist eine von drei Bewegungsformen, mit denen ein
Flugzeug auf eine Störung der Seitenbewegung antwortet.
Die \emph{Rollbewegung} klingt rasch ab, und die
\emph{Spiralbewegung} kann durch den Piloten leicht korrigiert werden.
Die Dutch Roll dagegen ist eine Schwingung, bei der offen bleibt, ob
sie abklingt.
