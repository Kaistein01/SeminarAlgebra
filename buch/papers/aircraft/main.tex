...
Ihre Lösung drückt die Stabilität in einem einzigen Wert aus.

\input{papers/aircraft/0-motivation.tex}
\input{papers/aircraft/1-grundbegriffe.tex}
\input{papers/aircraft/2-system.tex}
\input{papers/aircraft/3-stabilitaet.tex}
\input{papers/aircraft/4-eigenwerte.tex}
\input{papers/aircraft/5-interpretation.tex}
\input{papers/aircraft/6-beispiel.tex}
\input{papers/aircraft/7-fluegel.tex}
\input{papers/aircraft/8-grenzen.tex}
\input{papers/aircraft/9-fazit.tex}
